    ...
    return (
        <section className='flex flex-col md:flex-row items-center justify-center h-full py-10 mb-48 px-8 m-auto'> 
            <div className='md:pr-10 mb-10 md:mb-0 text-center md:text-left'>
                ...
                <p className='text-sm md:text-base py-5 leading-7 text-text'>I am a software developer with experience in creating scalable and reliable web applications using various frameworks and technologies. I enjoy solving problems, learning new skills, and writing high-quality code that adheres to best practices and industry standards.</p>
                <div>
                    <a href='#projects'>
