    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-center h-full py-10 mb-48 px-4 md:px-0 m-auto'> 
            <div className='md:pr-10 mb-10 md:mb-0 text-center md:text-left'>
                <h2 className='text-3xl md:text-4xl py-2 text-primary font-semibold'>Daniel Stephen Celestial</h2>
                <h3 className='text-lg md:text-xl py-1 text-secondary'>Software Developer</h3>
                <p className='text-md md:text-md py-5 leading-6 text-text'>I am a software developer with experience in full-stack web development. I have experience in building scalable, secure and reliable web applications using various frameworks and technologies. I enjoy solving complex problems and learning new skills. I am passionate about creating high-quality code that follows best practices and industry standards.</p>
                <div>
                    <a href='#projects'>
